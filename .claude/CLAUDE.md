...
🔜 **Next session**:
- Phase 4 (more) – `<Score>` (ABC.js/Verovio), `<EQGraph>`, `<PedalSignalFlow>`, `<HarmonyDiagram>`; series feature; year-in-review.
